function estimARMA(CovEmp::Array{Float64, 3}, Num::Array{Float64, 3},
  hip::Int64, method::Symbol, lastcoh=lastcoh, agecell=agecell,
  tmax=tmax, nlag=nlag, tik=tik)
  ...
  x_0[5+2*hip:5+2*hip+tmax-1] = π_1[1:tmax]
